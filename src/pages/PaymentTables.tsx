...
export default function PaymentTables() {
  ...
  return (
    <PageLayout title="Tabelas de Pagamento">
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <Button onClick={handleOpenNewTable} className="mt-4">
                <Plus className="mr-2 h-4 w-4" /> Adicionar Tabela
              </Button>
            </div>
          ) : (
          ...
          <Dialog open={openNewTableDialog} onOpenChange={setOpenNewTableDialog}>
            <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>
                  {editTableId 
                    ? "Altere as informações da tabela de pagamento."
                    : "Crie uma nova tabela de pagamento para sua empresa."
                  }
                </DialogDescription>
              </DialogHeader>
              <Form {...form}>
      ...
      {editTableId && (
        <PaymentTableTermsManager tableId={editTableId} />
      )}
    </PageLayout>
  );
}
...
function PaymentTableTermsManager({ tableId }: PaymentTableTermsManagerProps) {
  const { paymentTables, updatePaymentTable } = useAppContext();
