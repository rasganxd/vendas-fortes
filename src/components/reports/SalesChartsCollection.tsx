...
export const SalesChartsCollection: React.FC<SalesChartsCollectionProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Top Produtos por Receita</CardTitle>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Pedidos por Vendedor</CardTitle>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={salesRepPerformance.slice(0, 6)}>
              ...
              />
              <Bar dataKey="ordersCount" fill="#F59E0B" />
            </BarChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
