...
import { Copy, Key, Plus, Trash2, AlertCircle, CheckCircle, Smartphone, Book, Wifi, WifiOff } from "lucide-react";
...
const ApiTokensPanel: React.FC = () => {
  ...
  const checkApiStatus = async () => {
    try {
      const response = await fetch('https://ufvnubabpcyimahbubkd.supabase.co/functions/v1/mobile-sync', {
        method: 'OPTIONS',
      });
      setApiStatus({
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">
                API Mobile: {apiStatus.isOnline ? 'Online' : 'Offline'}
              </p>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Como Usar os Tokens no App Mobile
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-sm text-blue-800 mt-2">
              Este é o endereço único que você deve configurar no seu aplicativo mobile.
            </p>
          </div>

          {/* Como usar */}
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <h4 className="font-semibold text-green-900 mb-2">Como Configurar no App Mobile:</h4>
            <div className="space-y-2">
              <p className="text-sm text-green-800">
                <strong>1.</strong> Crie um token acima para o vendedor
              </p>
              <p className="text-sm text-green-800">
                <strong>2.</strong> Copie o token quando aparecer na tela
              </p>
              <p className="text-sm text-green-800">
                <strong>3.</strong> No app mobile, configure:
              </p>
              <div className="ml-4 space-y-1">
                <div className="bg-white p-2 rounded border">
                  <strong>URL:</strong> https://ufvnubabpcyimahbubkd.supabase.co/functions/v1/mobile-sync
                </div>
                <div className="bg-white p-2 rounded border">
                  <strong>Token:</strong> cole o token que você copiou
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
            ...
            <ul className="text-sm text-purple-800 space-y-1">
              <li>• <strong>Baixar dados:</strong> Lista de produtos e clientes atualizados</li>
              <li>• <strong>Enviar pedidos:</strong> Pedidos feitos no app mobile</li>
              <li>• <strong>Ver estatísticas:</strong> Acompanhar quantos pedidos foram enviados</li>
            </ul>
          </div>
          ...
          <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <ul className="text-sm text-yellow-800 space-y-1">
              ...
              <li>• Cada vendedor precisa de seu próprio token</li>
            </ul>
          </div>
        </CardContent>
      </Card>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Crie um token de acesso para permitir que o aplicativo mobile do vendedor se conecte ao sistema.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="Ex: App Mobile - João"
              />
            </div>
            <div>
      ...
      <Dialog open={showTokenDialog} onOpenChange={setShowTokenDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Copie o token abaixo e configure no app mobile. Por segurança, ele só será exibido uma vez.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
